...
const buildPlaceholder = (title, description) => (
...
const routes = [
  ...
  { path: '/login', element: <Login />, private: false },
  {
    ...
    children: [
      ...
      {
        path: 'relatorios',
        element: buildPlaceholder(
          'Relatórios',
          'Painel em desenvolvimento para o time de gestão'
        )
      },
      { path: 'ambiente', element: <AmbienteTrabalho /> },
      {
        ...
        element: buildPlaceholder(
          'Configurações',
          'Ajustes da sua conta e da operação em breve'
        )
      }
    ]
  },
    ...
    children: [
      ...
      { path: 'dicas', element: <DicasBemEstar /> },
      {
        ...
        element: buildPlaceholder(
          ...
          'Em breve mostramos as entradas enviadas aqui'
        )
      }
    ]
  }
